...
class LazerCutting(Base):
    ...
    estimated_cutting_time: Mapped[Optional[datetime.datetime]] = mapped_column(DateTime)
    real_cutting_time: Mapped[Optional[datetime.datetime]] = mapped_column(DateTime)
